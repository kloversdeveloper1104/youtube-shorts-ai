...
- タイトル(title)は本文(scenes)で実際に語る内容の範囲を超えて誇張しないこと。
  「実質無料」「悪用厳禁」「裏技」等の強い言葉を使うなら、本文で必ずその根拠・具体例を
  提示すること(タイトルと中身が一致しない釣りタイトルは厳禁)
- 煽り表現は要点を強調する程度にとどめ、視聴者の不安を過剰に煽る表現は避けること`;
